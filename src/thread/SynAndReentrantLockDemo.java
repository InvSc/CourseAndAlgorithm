...
enum ThreadEnum {
    ...
    public static com.invsc.miaosha.thread.ThreadEnum ForEachThreadEnum(String str) {
        com.invsc.miaosha.thread.ThreadEnum[] myArray = com.invsc.miaosha.thread.ThreadEnum.values();
        for (com.invsc.miaosha.thread.ThreadEnum threadEnum : myArray) {
...
//        SharedResource data = new SharedResource();
        com.invsc.miaosha.thread.Resource data = new com.invsc.miaosha.thread.Resource();
        new Thread(() -> {
            for (int i = 0; i < 10; i++) {
                data.print5();
            }
