...
public class DeadLockDemo {
    public static void main(String[] args) {
        String lockA = "lockA";
        String lockB = "lockB";
        new Thread(new com.invsc.miaosha.thread.holdLockThread(lockA, lockB), "AAA").start();
        new Thread(new com.invsc.miaosha.thread.holdLockThread(lockB, lockA), "BBB").start();
    }
    /**
     * 如何排查故障
     *      jps -l
